...
public class UtilsJson {
	 ...
	 * @return
	 */
	public static Object toObject(String jsonString, Class pojoCalss) {
		...
		if (dtoArray != null && dtoArray.length > 0) {
			for (int i = 0; i < dtoArray.length; i++) {
				try {
					Class c = Class.forName(pojoCalss.getName());
					Object o = c.newInstance();
					o = UtilsJson.toObject(dtoArray[i].toString(),
							pojoCalss);
					result.add(o);
				} catch (ClassNotFoundException e) {
					e.printStackTrace();
	...
	public static void main(String[] args) {
		Map<String,Object> map =UtilsJson.toMap("{    \"pivotNamedList\": [        {            \"value\": [                {                    \"value\": \"内蒙古\",                    \"field\": \"produceProvince\",                    \"count\": 1,                    \"pivot\": [                        {                            \"value\": \"呼和浩特市\",                            \"field\": \"produceCity\",                            \"count\": 1,                            \"pivot\": [                                {                                    \"value\": \"清水河县\",                                    \"field\": \"produceArea\",                                    \"count\": 1                                }                            ]                        }                    ]                },                {                    \"value\": \"山东省\",                    \"field\": \"produceProvince\",                    \"count\": 1,                    \"pivot\": [                        {                            \"value\": \"济南市\",                            \"field\": \"produceCity\",                            \"count\": 1,                            \"pivot\": [                                {                                    \"value\": \"历城区\",                                    \"field\": \"produceArea\",                                    \"count\": 1                                }                            ]                        }                    ]                }            ],            \"key\": \"produceProvince,produceCity,produceArea\"        },        {            \"value\": [                {                    \"value\": \"\",                    \"field\": \"ex_carCat\",                    \"count\": 1,                    \"pivot\": [                        {                            \"value\": \"\",                            \"field\": \"ex_carBrand\",                            \"count\": 1,                            \"pivot\": [                                {                                    \"value\": \"\",                                    \"field\": \"ex_carSeries\",                                    \"count\": 1,                                    \"pivot\": [                                        {                                            \"value\": \"\",                                            \"field\": \"ex_carType\",                                            \"count\": 1                                        }                                    ]                                }                            ]                        }                    ]                },                {                    \"value\": \"重卡\",                    \"field\": \"ex_carCat\",                    \"count\": 1,                    \"pivot\": [                        {                            \"value\": \"中国重汽\",                            \"field\": \"ex_carBrand\",                            \"count\": 1,                            \"pivot\": [                                {                                    \"value\": \"豪沃\",                                    \"field\": \"ex_carSeries\",                                    \"count\": 1,                                    \"pivot\": [                                        {                                            \"value\": \"豪沃2010\",                                            \"field\": \"ex_carType\",                                            \"count\": 1                                        }                                    ]                                }                            ]                        }                    ]                }            ],            \"key\": \"ex_carCat,ex_carBrand,ex_carSeries,ex_carType\"        }    ]}");
