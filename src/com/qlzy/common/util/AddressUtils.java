...
public class AddressUtils {
    ...
    public static String getAddress(String content, String encodingString) throws UnsupportedEncodingException{
        ...
        if (returnStr != null) {
            ...
            Map<String,Object> rtnMap = UtilsJson.toMap(returnStr);
            if(null != rtnMap && rtnMap.size() > 0){
                Map<String,Object> rtnMap1 = UtilsJson.toMap(String.valueOf(rtnMap.get("data")));
                if(null != rtnMap1 && rtnMap1.size() > 0){
                    String country = String.valueOf(rtnMap1.get("country"));
                    if(country.equals("香港") || country.equals("澳门") || country.equals("台湾")){
                        return "中国";
                    }else if("内网IP".equals(String.valueOf(rtnMap1.get("county")))){
                        return "中国";
                    }
                    return country;
                }else{
     ...
     * @throws UnsupportedEncodingException
     */
    public String getAddresses1(String content, String encodingString)
            throws UnsupportedEncodingException {
        // 这里调用pconline的接口
        String urlStr = "http://ip.taobao.com/service/getIpInfo.php";
        // 从http://whois.pconline.com.cn取得IP所在的省市区信息
