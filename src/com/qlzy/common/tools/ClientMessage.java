...
//	private String serviceURL = "http://report.zucp.net:8060/reportservice.asmx";
	...
	private String sn = "SDK-MKJ-010-00259";// 序列号
	private String password = "";
	private String pwd = "372410";// 密码

	/*
	 * 构造函数175259202  
	 */
	public ClientMessage(String sn, String password)
	...
	public String mdsmssend(String mobile, String content, String ext, String stime,
		...
		return HttpsClient.sendMessage(mobile, content);
		/*
		String result = "";
	...
	public static void main(String[] args) throws UnsupportedEncodingException
	{
		...
		String sn="SDK-MKJ-010-00259";
		String pwd="372410";
		ClientMessage client=new ClientMessage(sn,pwd);

		//短信发送	
        String   content   =   java.net.URLEncoder.encode("您在颐佳商城的代金券：***** ，有效期为 ***  。请您尽快使用此券，过期作废。【古粮今典】",  "utf-8");
		String result_mt = client.mdsmssend("13964129956", content, "", "", "", "");		
