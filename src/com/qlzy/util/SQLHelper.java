...
public class SQLHelper
{
	 ...
	 * @return 数据库名称
	 **************************************************************************/
    public static String getDataBaseType(Connection con)
        throws Exception
    {
        String name = null;
        try{
    ...
    public static List getSelectParam(String SQL)
        throws Exception
    {
        ...
        for(int j = 0; j < splitListForWhere.length; j++)
        {
            ...
            for(int i = 0; i < splitListForAnd.length; i++)
            {
                ...
                if(splitListForAnd[i].indexOf("?") != -1)
                {
                    ...
                    if(splitListForAnd[i].indexOf("like") != -1)
                        splitList = splitListForAnd[i].split("like");
                    else
                    if(splitListForAnd[i].indexOf("in") != -1)
