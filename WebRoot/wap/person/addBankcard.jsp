...
<div class="mui-content">
    <form id="addForm">
    <ul class="buy_list">
        <input class="buy_input" type="hidden" name="id" id="id"/>
        <li>
            <div class="list_left">持卡人</div>
            <div class="list_right">
                <input class="buy_input" type="text" name="name" id="name"/>
            </div>
        </li>
        <li>
            <div class="list_left">卡号</div>
            <div class="list_right color_666">
                <input class="buy_input" type="text" name="cardNumber" id="cardNumber"/>
            </div>
        </li>
        <li>
            <div class="list_left">银行名称</div>
            <div class="list_right">
                <input class="buy_input" type="text" name="bank" id="bank" placeholder="如招商银行、中国银行"/>
            </div>
        </li>
        <li>
            <div class="list_left">开户行</div>
            <div class="list_right">
                <input class="buy_input" type="text" name="openBank" id="openBank"/>
            </div>
        </li>
    </ul>
    </form>
