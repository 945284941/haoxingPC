    ...
    <ul class="buy_list">
        <li>
            ...
            <div class="list_right">
                <input class="buy_input" type="text" name="receiveName" id="receiveName"/>
            </div>
        </li>
        <li>
            <div class="list_left">手机号</div>
            <div class="list_right color_666">
                <input class="buy_input" type="text" name="mobile" id="mobile"/>
            </div>
        </li>
        <li>
            <div class="list_left">邮编</div>
            <div class="list_right color_666">
                <input class="buy_input" type="text" name="zip" id="zip"/>
            </div>
        </li>
        <li>
            <div class="list_left">所在国家</div>
            <div class="list_right color_666">
                <p class="right_down iconfont" style="right:30px">&#xe618;</p>
        ...
        <li>
            ...
            <div class="list_right">
                <input class="buy_input" type="text" name="receiveAddress" id="receiveAddress" placeholder="请填写城市、街道等详细信息" />
            </div>
        </li>
    </ul>
    </form>
