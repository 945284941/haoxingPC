...
<!-- 头部结束 -->
<!-- 页脚开始 -->
<div class="dht">首页  &gt; 会员中心 &gt;我的参与  &gt; 供求信息</div>
<div class="gzgz">
      <div class="hyleft">
     ...
     <div class="hyright gqxxzx">
      <div class="hyrightr">
       <div id="rightjxw">
           <p class="hyd0" >整车供求总数<span id="zhengche"></span></p>
           <p class="hyd0">配件供求总数<span id="peijian"></span></p>
           <p class="hyd0">设备供求总数<span id="shebei"></span></p>
         ...
         <div class="grgqlb">
           <ul>
             ...
             <s:if test="status==0"></s:if>
             	<li class="grgqfive">求购信息</li>
             <s:else>
             	<li class="grgqfive">供应信息</li>
             </s:else>
