...
<div class="gzgz">
     ...
     <div class="hyright">
      <div class="hyrightr">
       ...
       <span class="integralbt"><a class="hover">余额记录</a></span>
       <span class="integralbt_jfsc"><a href="#">经验值商城</a></span>
       </p>
       <div class="integralbt_listbt">
          <dl>
            <dt>
            	<span class="integralbt_time2">时间</span><span class="integralbt_time2">经验值类型</span><span class="integralbt_time2">经验值余额</span>
            </dt>
             <s:iterator value="pointDetailList" >
            		<dd>
	            		<span class="integralbt_time2"><s:date format="yyyy-MM-dd" name="%{createtime}"/></span>
	            		<span class="integralbt_time2">
							余额
						</span>
	            		<span class="integralbt_time2">${balance}</span>
            		</dd>
           	</s:iterator>
          </dl>
           <div id="showpages">
