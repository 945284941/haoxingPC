	...
	<div class="gzgz">
		...
		<div class="hyright">
			...
			<div class="aqwt aqwtdd">
				<form action="/person/order/myChOrders/1.html" id="person_orders_orderForm" name="person_orders_orderForm" method="post">
			...
			<div class="lbcontant2">
				...
				<s:iterator var="o" value="orderList" status="status">
					<div class="sclb2">
						...
						<span style="width:150px;">订单编号：${o.orderNum}</span><span style="width:180px;">下单时间：<s:date name="#o.createtime" format="yyyy-MM-dd HH:mm:ss"/></span>
						<span style="width:190px;">买家信息：${o.companyName} </span>
					...
					<s:iterator var="i" value="#o.items" status="st">
						<div class="zxlb zxlb2 wddd">
							<ul>
								...
								<li class="ddeight" style="width:62px; margin-left:18px;"><a href="person/order/sellChOrderItem/${o.id}.html">查看</a></li>
				...
				<!-- 分页开始 -->
				<div id="showpages">
					<page:pagination path="person/order/myChOrders/1.html" formName="person_orders_orderForm" />
				</div>
				<!-- 分页结束 -->
			</div>
		</div>
