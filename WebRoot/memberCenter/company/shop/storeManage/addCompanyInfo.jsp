...
<!-- 页脚开始 -->
<div class="dht">首页 &gt; 会员中心 &gt;店铺管理 &gt; 添加咨询</div>
<div class="gzgz">
     <div class="hyleft">
     ...
     <div class="hyright">
       ...
       <h2><a href="memberManageCompanyInfo.html">资讯列表</a><span>发布资讯</span></h2>
       <div class="grjbxx3 grjby">
       <form action="memberManageAction!addCompanyInfo.action" method="post">
         <p><em>资讯标题：</em>
      		<input name="companysInfo.firstTitle" class="zxtitle"/></p>
         <div class="zx2"><em>资讯标题：</em><br/>
         <div class="zxnr">
         	<textarea name='companysInfo.content' 
						id="admin_add_companyInfo_textarea_${company.id}" ></textarea>
