...
<div id="slides" class="gzgz banner_vip">
	...
	<div class="bannerImg">
		...
		<s:else>
			...
			<div style="DISPLAY: none" id="banner_pic_2">
				<img src="images/vip/banner02.jpg" width="1179" height="323" />
			</div>
		</s:else>
		</div>
	</div>
	<div class="banner_new_r">
		<a class="next" href="javascript:void(0)"><img alt="下一页" src="images/banner_r.png"
			width="24" height="43" />
		</a>
	</div>
</div>
