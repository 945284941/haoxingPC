     ...
     <div class="hyright">
      <div class="hyrightr">
       ...
       <div class="hylist">
		   ...
		   <s:else>
		   			<a style="margin-left:10px; text-decoration:underline" onclick="openOrderPage('/person/accountSecurity.html');">没有密码？<b style="color:red">设置</b></a>
		   </s:else>
	   </div>
       <div class="hylist">
           ...
           <span  class="sjdx"><em>*</em><input id="yanzheng" class="dxyz" type="button" onclick="gainMobile();" value="短信验证" /><input name="advanceLogs.yanzhengMobile"  disabled="disabled" id="duanxinNum" class="ddtextdxyzm" onfocus="clearValue(this.id);" value="验证码"/></span><span id="mobileSpan"></span>
		     ...
		     <s:else>
		     	<a onclick="openOrderPage('/person/accountSecurity.html');" style="color: red;">手机未绑定，点击绑定手机</a>
		     </s:else>
	   </div>
	   <s:if test="statusMobile==1 && payPassword!=null">
