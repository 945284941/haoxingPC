...
<div class="breadThumb">首页 > 会员中心 > 电子商城 > 我的参与 > 我的帖子</div>
<div class="gzgz">
	<div class="hyleft">
		<c:choose>
	...
	<div class="hyright">
		...
		<table class="table table-striped table-bordered myforumTable">
			...
			<tr>
				<td>
					<a href="HuiTieIndex/${v.id }.html" title="${v.title }">${fn:substring(v.title, 0, 22)}</a>
				</td>
				<td width="120">
		...
		<!--======================翻页开始============================-->
	     <form id="pagerForm" name="pagerForm" action="myforum/${userId }.html" method="post">
		 ...
		 <div class="fenye"  id="showpages">
		   <page:pagination path="myforum/${userId }.html" formName="pagerForm"/>
		 </div>
        </div>
	</div>
</div>
