...
<script  type="text/javascript">
	...
	function seePurchaseHistory(id) {
		window.location.href='person/purchaseHistory/'+id+'/3.html';
	}
</script>
<!-- 解决IE6不缓存背景图片的问题-->
<!--[if IE 6]>
 ...
 <div class="hyright">
       	 <table class="table table-bordered myTableList">
       	 	...
       	 	<s:iterator value="memberList" >
       	 	  ...
       	 	  <form id="pagerForm" name="pagerForm" action="person/mySanji.html" method="post">
		 ...
		 <div class="fenye"  id="showpages">
		   <page:pagination path="person/mySanji.html" formName="pagerForm"/>
		 </div>
   </div>         
</div>
