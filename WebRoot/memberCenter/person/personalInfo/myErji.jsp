...
<script  type="text/javascript">
	...
	function seePurchaseHistory(id) {
		window.location.href='person/purchaseHistory/'+id+'/2.html';
	}
</script>
<!-- 解决IE6不缓存背景图片的问题-->
<!--[if IE 6]>
...
<div class="gzgz">
 ...
 <div class="hyright">
       	 <table class="table table-bordered myTableList">
       	  ...
       	  <form id="pagerForm" name="pagerForm" action="person/myErji.html" method="post">
		 ...
		 <div class="fenye"  id="showpages">
		   <page:pagination path="person/myErji.html" formName="pagerForm"/>
		 </div>
   </div>         
</div>
