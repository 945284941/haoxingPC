...
<meta http-equiv="description" content="古道金典是重汽配件产业的首选信息门户网站和电子商务网站，填补行业的信息空白和电子商务空白，通过古道金典的优势资源，为您提供直达高端客户的专业广告服务。" />
<title>诚聘英才</title>
	...
	<div class="gzgz">
		<div class="hyleft">
			...
			<dl class="grhymenu">
				...
				<div class="hyright">
			<p class="hymainbt">
				<span class="grmenubt">岗位详情</span>
			</p>
			<div class="grjbxx">
				<div style="padding-left:17px;">
					${zpMessage.detailMessage}
			</div>
			</div>
