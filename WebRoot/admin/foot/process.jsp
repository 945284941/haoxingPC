...
<meta http-equiv="keywords" content="购物流程，购物步骤" />
<meta http-equiv="description" content="古道金典用户购物流程步骤。" />
<title>购物流程</title>
...
<body>
	...
	<!-- 页脚开始 -->
	<div class="dht">
		<a href="javascript:void(0)">首页</a> > <a href="javascript:void(0)">新手指南</a>
	...
	<div class="gzgz">
		<div class="hyleft">
			...
			<dl class="grhymenu">
				...
				<dd class="add">
					<a class="hover" href="/admin/foot/process.jsp">购物流程</a>
				</dd>
				<dd class="add">
		...
		<div class="hyright">
			<p class="hymainbt">
				<span class="grmenubt">购物流程</span>
			</p>

			<div class="grjbxx">
				<div class="hyhdxznr">
					<p style="float:left;">
						<img src="/images/footerImg/gwlc.gif" width="509" height="618" />
					</p>
				</div>
			</div>
		</div>
