...
<meta http-equiv="keywords" content="古道金典" />
...
<body>
	...
	<!-- 页脚开始 -->
	<div class="dht">
		<a href="javascript:void(0)">首页</a> > <a href="javascript:void(0)">关于泉利</a> > <a href="javascript:void(0)">公司简介</a>
	</div>
	<div class="gzgz">
		<div class="hyleft">
	<dl class="grhymenu">
		...
		<dd class="add">
			<a class="hover" href="/admin/foot/company.jsp">公司简介</a>
		</dd>
		<dd class="add">
	...
	<dl class="grhymenu">
		...
		<div class="hyright">
			<p class="hymainbt">
				<span class="grmenubt">公司简介</span>
			</p>

			 <div class="grjbxx"> </div>
		</div>
