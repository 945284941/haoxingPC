			...
			<div class="fb_content">
				<div class="fb_1">
					...
					<div class="fb_con2">
							...
							<div class="fb_fl">
								<div>
									<input type="text" class="text easyui-validatebox"
										name="supply.title" data-options="required:true">
								</div>
							</div>
							<div class="clr"></div>
						</div>
						...
						<div class="item">
							<span class="label"><strong style="color:#ff0006; ">*&nbsp;&nbsp;</strong>设备名称：</span>
							<div class="fb_f2">
								<div>
									<input type="text" class="text easyui-validatebox"
										name="supply.name" data-options="required:true">
								</div>
							</div>
							<div class="clr"></div>
						</div>
						...
						<div class="item">
							...
							<div class="fb_gqfl">
								<label><input type="radio" checked="checked"
									name="supply.quality" class="inRadio_blue" value="全新">全新</label>
								<label><input type="radio" name="supply.quality"
									class="inRadio_blue" value="较新">较新</label> <label><input
									type="radio" name="supply.quality" class="inRadio_blue"
									value="一般">一般</label> <label><input type="radio"
									name="supply.quality" class="inRadio_blue" value="较差">较差</label>
							</div>
							<div class="clr"></div>
						</div>
						<div class="item">
							...
							<div class="fb_fl fb_f7">
								<div>
									<SELECT class="text easyui-validatebox" id="province"
										data-options="required:true" name="supply.provinceId">
							...
							<div class="fb_fl fb_f7">
								<div>
									<SELECT class="text easyui-validatebox"
										data-options="required:true" name="supply.cityId" id="city"
										style="display: none">
							...
							<div class="fb_fl fb_f7">
								<div>
									<SELECT class="text easyui-validatebox"
										data-options="required:true" name="supply.areaId" id="area"
										style="display: none">
						...
						<div class="item" style="padding-top:10px;">
							...
							<div class="fb_fl fb_f4">
								<input type="text" class="text easyui-numberbox"
									name="supply.price" data-options="min:0,precision:2">
							</div>
							<span class="y">元</span>
							<div class="my">
								<label><input type="checkbox" class="chk" value="553664"
									id="guohufeiyong" name="guohufeiyong">可面议</label>
							</div>
						...
						<div class="item">
							...
							<div class="fb_f2 fb_f5">
								<div>
									<input name="supply.effectivetime" type="text"
										readonly="readonly"
						...
						<div class="item">
							...
							<div class="fb_fl fb_f5">
								<input type="text" class="text easyui-validatebox"
									name="supply.linkman" data-options="required:true">
							</div>
							<div class="clr"></div>
						</div>
						<div class="item">
							...
							<div class="fb_fl fb_f5">
								<input type="text" class="text easyui-validatebox"
									name="supply.linkmobile" data-options="required:true">
							</div>
							<div class="clr"></div>
						</div>
						<div class="item">
