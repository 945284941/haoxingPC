...
<body id="mainbody" onload="slideShow()">
	...
	<div class="gzgz_content">
		...
		<div class="subcontent">
			...
			<p>
				<span style="width:750px;">运送范围：${obj.deliveryScope }</span>
			</p>
			<p>
	...
	<div class="gzgz_content">
		<div class="gzgz_coleft">
			...
			<div class="grxx">
				<h3>物流信息：</h3>
				<p>
					<span>运送方式：${obj.transportMode }</span><span>是否往返：${obj.isRound
						}</span><span>有无中转：${obj.isTransit }</span><span>班次：${obj.isFixedshift
						}</span><span>租赁方式：${obj.organizegoodsMode }</span><span>服务延伸：${obj.serviceMode
						}</span><span>货物种类：${obj.goodsType }</span>
				</p>
			</div>
			<div class="grxx">
				<h3>补充说明：</h3>
