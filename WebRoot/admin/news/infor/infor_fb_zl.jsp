				...
				<div class="fb_1">
					...
					<div class="fb_con2">
						<div class="item">
							...
							<div class="fb_fl">
								<div>
									<input type="text" class="text easyui-validatebox" data-options="required:true" name="supply.title">
								</div>
							</div>
							<div class="clr"></div>
						</div>
						...
						<div class="item">
							...
							<div class="fb_gqfl">
								<label><input type="radio" checked="checked" name="supply.leaseType"
									class="inRadio_blue" value="仓储">仓储</label> <label><input
									type="radio" name="supply.leaseType" class="inRadio_blue" value="办公">办公</label>
								<label><input type="radio" name="supply.leaseType"
									class="inRadio_blue" value="商铺">商铺</label> <label><input
									type="radio" name="supply.leaseType" class="inRadio_blue" value="其他">其他</label>
							</div>
							<div class="clr"></div>
						</div>
						<div class="item">
								...
								<div class="fb_fl fb_f7">
									<div>
										<SELECT class="text easyui-validatebox" name="supply.provinceId" data-options="required:true" id="province">
								...
								<div class="fb_fl fb_f7">
									<div>
										<SELECT class="text easyui-validatebox" name="supply.cityId" data-options="required:true" id="city" style="display: none">
								...
								<div class="fb_fl fb_f7">
									<div>
										<SELECT class="text" id="area" name="supply.areaId" style="display: none">
							...
							<div class="item">
								...
								<div class="fb_f2">
									<div>
										<input type="text" class="text easyui-validatebox" data-options="required:true" id="address" name="supply.address">
									</div>
								</div>
								<div class="clr"></div>
							</div>
							...
							<div class="fb_fl fb_f4">
								<input type="text" class="text easyui-numberbox"name="supply.acreage" data-options="min:0,precision:2">
							</div>
							<span class="y">平米</span>
							<div class="my">
								<label><input type="checkbox" class="chk">可面议</label>
							</div>
