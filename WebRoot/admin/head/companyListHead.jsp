	...
	<div id="warp">
		<div class=" bannerzong">
			<ul class="mainnavzong">
				<li><a class="hover" href="http://www.qlqpw.com" target="_self">商城首页</a>
				</li>
				...
				<li><a href="magazine/magazineMain.html">泉利杂志</a></li>
			...
			<div class="sjlbright">
				...
				<div class="cplistrightsjlb">
					<div class="sjlbsplist">
						<form action="gainCompanyListHead.html" id="sjlbsplistSearchForm"
							name="sjlbsplistSearchForm" method="post">
							<input type="hidden" id="searchType" name="searchType"
								value="<s:property value='#request.searchType'/>" /> <input
								type="hidden" id="topSearchLike" name="topSearchLike"
								value="<s:property value='#request.topSearchLike'/>" /> <input
								id="order" name="order" type="hidden" value="${order}" />
							<div class="sppxbt">
								<span class="sppx">商家排序：</span><span class="mrpx">默认排行</span>

								<s:if test="order=='asc'">
									<span class="gxtime" onclick="_orderByUpdatetime('desc')"
										id="orderByUpdatetime">入驻时间</span>
								</s:if>
								<s:else>
									<span class="gxhead" onclick="_orderByUpdatetime('asc')"
										id="orderByUpdatetime">入驻时间</span>
								</s:else>
							</div>
						</form>
						<s:if test="%{companyList.size()>0}">
							<s:iterator value="companyList" var="li" status="st">
								<div class="sjlb_cpcx">
									<div class="sjlb_left">
										...
										<p class="sjlb_cppic">
											<s:if test="null!=#li.storefrontSrc&&''!=#li.storefrontSrc">
												<a href="/Shop/index_${li.id}.html" target="_blank"><img
													src="/images/<s:property value='#li.storefrontSrc'/>"
													width="147" height="110" /> </a>
											</s:if>
											<s:else>
												<a href="/Shop/index_${li.id}.html" target="_blank"><img
													src="/images/330-206zwpic.gif" width="147" height="110" />
												</a>
											</s:else>
										</p>
										<p class="sjlb_leftjxs">
											<span class="jxsmz"> 
											<s:if test='"1" eq #li.shCheck'>
													<a href="http://www.sdqpsh.com/" target="_blank"><img src="/images/sh/shbs.jpg" width="60px;" height="30px;" /></a>
												</s:if> 经销商名：<a href="/Shop/index_${li.id}.html" target="_blank"><s:property
														value='#li.companyName' /> </a> </span> <span class="ckmap">
												  
												<a href="javascript:void(0)"
												id="view-map-link" title="点击查看地图"
										...
										<dl>
											<dd class="sjlbhyjb">
												<span class="jz">会员级别：</span><span class="hyjbgood"><img
													src="/images/levelIcon/${li.vipGradeImgSrc}"
													title="${li.vipLevelName}" /> </span>
											</dd>
											<dd>
												联系电话：
										...
										<div class="zfxw">
											<p class="sjlbhyjb">
												<span class="jz">质量等级：</span> <span class="zldjbz"> <s:if
														test='null!=#li.qualityImgSrc&&""!=#li.qualityImgSrc'>
														<img src="/images/levelIcon/${li.qualityImgSrc}" />
													</s:if> <s:else>0级</s:else> </span>
											</p>
											<p class="sjlbhyjb">
												<span class="jz">服务等级：</span> <span class="zldjbz"> <s:if
														test='null!=#li.serveImgSrc&&""!=#li.serveImgSrc'>
														<img src="/images/levelIcon/${li.serveImgSrc}" />
													</s:if> <s:else>0级</s:else> </span>
											</p>
											<p class="sjlbhyjb">
												<span class="jz">信誉等级：</span> <span class="zldjbz"> <s:if
														test='null!=#li.creditImgSrc&&""!=#li.creditImgSrc'>
														<img src="/images/levelIcon/${li.creditImgSrc}" />
													</s:if> <s:else>0级</s:else> </span>
											</p>
											<p class="sjlbhyjb">
												<span class="jz">物流等级：</span> <span class="zldjbz"> <s:if
														test='null!=#li.logisticsImgSrc&&""!=#li.logisticsImgSrc'>
						...
						<!-- 分页开始 -->
						<div id="showpages">
							<page:pagination path="gainCompanyListHead.html"
