...
<div class="sghsc-pay-box">
  ...
  <div class="sghsc-pay-sus-x">${message }</div>
   <div class="sghsc-pay-sus-gb"><a href="payment!toPaymentType.action?orderId=${order.id}" target="_self"><input type="submit" value="重新支付" class="sghsc-pay-btn sghsc-pay-btn-2" /></a></div>
 </div>
