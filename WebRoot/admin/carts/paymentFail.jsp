...
<html>
  ...
  <!-- header end -->
    <div class="dht">支付成功</div>
	<div class="shop">
  <div style=" width:293px; margin:20px auto 0"><img src="/images/shop/jysb.gif" alt="支付失败" /></div>
  <div class="splb splbtwo">
    <h2>订单状态</h2>
        <div class="cplb">
            <div class="cc name"><span class="price">订单编号</span></div>
            <div class="cc lb"><span class="price">${orderNum}</span></div><div style="clear:both"></div>
        </div> 
        <div class="cplb">
            <div class="cc name"><span class="price">支付状态</span></div>
            <div class="cc lb"><span class="price">买家支付失败</span></div><div style="clear:both"></div>
        </div>
        <div class="cplb">
  ...
  <div class="zj">
      <span class="jsr"><a href="memberCallAction!toZfbPay.action?orderId=${orderId}">支付</a></span>
      <!--  span class="js"><a href="#">修改订单</a></span>
      <span class="js"><a href="#">撤销订单</a></span-->
    </div>
</div>
